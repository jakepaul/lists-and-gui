    ...
    public static class LinkedListTests {
        ...
        public static TestSuite suite() {
            ...
            return ListTestSuiteBuilder
                    // The create method is called with an array of element
                    // that should populate the collection.
                    .using(new TestStringListGenerator() {

                        @Override
                        protected AbstractList<String> create(String[] elements) {
                            return new MyLinkedList<>((AbstractList<? extends String>) Arrays.asList(elements));
                        }
        ...
        public static TestSuite suite() {
            ...
            return ListTestSuiteBuilder
                    ...
                    .using(new TestStringListGenerator() {
                        ...
                        @Override
                        protected AbstractList<String> create(String[] elements) {
                            return new MyArrayList<>((AbstractList<? extends String>) Arrays.asList(elements));
                        }
